...
Hero choice integration: fourteen targeted checks pass for paused selection, invalid/stale inputs, Multishot arrow count, Piercing primary fire, Volley damage, combined ranks, restoration and death retention. The portrait choice panel was rendered and inspected. Existing suites passed through campaign lifecycle; after updating fixtures to spend their earned choices, recovery (165), edges (25), continuation (1242), normal win/unattended loss, all six campaign wins and Android checks passed. Human playtesting and an updated APK remain outstanding.

0.4.0 Android playtest build: complete validation wrapper passed with the integrated combat, choices, enemy roles, tier visuals, Smith bulbs and feedback. Debug export succeeded; APK signature v2/v3 verification passed. Package com.example.emberwatch, versionCode 5, versionName 0.4.0, minimum SDK 24, target SDK 36. APK SHA256: 16AB1DB877E423E514072630C19A896A0A4A904E85C3CAAB1D4B082FAD890F85. Physical-device and human playtest acceptance remain unverified. See playtest_040.md.
